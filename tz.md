...
- **Улучшения:**
Уровень 1: +5 монет/минуту за уровень (стоимость: 100 )
Уровень 2: +4 монет/минуту за уровень (стоимость: 250 )
Уровень 3: +3 монет/минуту за уровень (стоимость: 500 )
Уровень 4: +2 монет/минуту за уровень (стоимость: 1000)
...
[//]**Казармы:**
- **Улучшения:**
- Уровень 1: разблокировка юнита ""
- Уровень 3: разблокировка юнита "" 
- Уровень 5: разблокировка юнита ""
...
**Временные затраты:**
- Минимальное время похода: 30 секунд (при минимально возможном расоянии деревень друг от друга )
