...
- `building_types` - типы зданий (константы)
- `unit_types` - типы юнитов (константы)
- `game` - игровые конфигурации
...
- `battle_objects` - объекты в сражениях
- `army` - перемещения армий

**Операционные таблицы (Operational Tables)**
- `buildings` - здания игроков
- `units` - юниты игроков

**Кэш/Хеш таблицы (Cache/Hash Tables)**
- `hashes` - хеши состояния чата
- `map_hashes` - хеши состояния карты
