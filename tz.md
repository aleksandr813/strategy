...
**Общее описание:**
Менеджмент деревни представляет собой игровое пространство , разделенное на две функциональные зоны равного размера (20×20 клеток каждая). Интерфейс обеспечивает полный контроль над развитием и защитой деревни.
