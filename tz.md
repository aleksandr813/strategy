...
- **Здоровье:** 
  ...
  - Уровень 4: 1150 HP (+150 за уровень)
  - Уровень 5: 1300 HP (+150 за уровень)
- **Стоимость улучшения:** 500 × текущий уровень монет
- **Время улучшения:** 10 минут × текущий уровень
...
- **Производство:**
  ...
  - Уровень 4: 28 монет/минуту
  - Уровень 5: 36 монет/минуту
- **Стоимость улучшения:** 300 × текущий уровень монет
- **Время улучшения:** 5 минут × текущий уровень
...
- **Здоровье:**
  ...
  - Уровень 4: 1000 HP
  - Уровень 5: 1200 HP
- **Вместимость:** 5 + (2 × текущий уровень) юнитов в очереди
- **Стоимость улучшения:** 400 × текущий уровень монет
- **Время улучшения:** 7 минут × текущий уровень
...
- **Время улучшения:** 2 минуты × текущий уровень
...
- **Характеристики атаки:**
  ...
  - Уровень 2: урон 18, дальность 5 клеток
  - Уровень 3: урон 22, дальность 6 клеток
  - Уровень 4: урон 27, дальность 6 клеток
  - Уровень 5: урон 33, дальность 7 клеток
- **Стоимость улучшения:** 200 × текущий уровень монет
- **Время улучшения:** 3 минуты × текущий уровень
...
- **Время восстановления:** 50% от исходного времени строительства(кроме Оборонительных сооружений ,им нужно полное время строительства)

**Визуальные индикаторы:**
- Прогресс-бар строительства/улучшения
- Индикатор здоровья над зданиями
- Цветовая маркировка уровня здания
- Эффекты повреждения при атаках
