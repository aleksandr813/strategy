...
### 4.2 Локальная карта (Интерфейс управления деревней)

**Общее описание:**
Локальная карта представляет собой игровое пространство , разделенное на две функциональные зоны равного размера (20×20 клеток каждая). Интерфейс обеспечивает полный контроль над развитием и защитой деревни.

**Структура карты:**

| Зона | Размер | Назначение | Особенности |
|------|--------|------------|-------------|
| **Зона строительства** | 20×20 клеток | Размещение зданий и оборонительных сооружений | - Сетка с визуальным выделением клеток - Подсветка доступных/недоступных позиций - Визуализация радиуса действия оборонительных сооружений |
| **Зона размещения юнитов** | 20×20 клеток | Формирование и позиционирование армии | - Разделение на секторы для разных типов юнитов - Индикация вместимости каждого сектор - Визуальное отображение готовности юнитов |
