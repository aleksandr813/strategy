...
## 5.11 Архитектура системы и база данных

### 5.11.1 Выбор типа базы данных
**Тип:** Реляционная (SQL) база данных

**Обоснование выбора:**

1. **Структурированность данных:** 
   - Игровые сущности (пользователи, юниты, здания) имеют четкую структуру и связи
   - Табличная модель идеально подходит для хранения информации о:
     - Пользователях (логин, пароль, статистика)
     - Игровых объектах (юниты, здания с фиксированными характеристиками)
     - Экономических показателях (монеты, транзакции)

2. **Целостность данных:**
   - Требуется гарантированная консистентность данных (ACID)
   - Важность избежания потерь и дублирования информации
   - Сложные связи между таблицами (пользователь → деревня → здания → юниты)

3. **Сложные запросы:**
   - Необходимость агрегации данных для рейтинговой таблицы
   - Статистические выборки и аналитика

4. **Транзакционность:**
   - Одновременные обновления данных от множества игроков

**Основные сущности базы данных:**
- `users` - пользователи и их учетные данные
- `villages` - деревни игроков
- `buildings` - здания и их уровни
- `units` - юниты игроков
- `battles` - история сражений
