...
**Общее описание:**
В игре представлены 11 типов юнитов с уникальными характеристиками, стоимостью и особенностями. Юниты открываются последовательно при улучшении Казарм.
...
| x | INT | NOT NULL | Координата по x |
| y | INT | NOT NULL | Координата по y |
